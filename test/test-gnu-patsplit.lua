...
local group = require "testgroup".new("luawk.runtime.gnu patsplit()")
...
group:add("patsplit: split path", function(R)
	local a = {}
	assert_equal(R.patsplit("/etc//passwd/", a, "[^/]+"), 2)
	assert_equal(table.concat(a, ","), "etc,passwd")
end)

group:add("patsplit: trailing case", function(R)
	local a, s = {}, {}
